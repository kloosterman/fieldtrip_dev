  ...
  case 'rpt'
    ...
    for i=1:numel(cfg.parameter)
      ...
      switch getdimord(varargin{1}, cfg.parameter{i})
        ...
        case {'rpt' 'rpt_chan' 'rpt_chan_time' 'rpt_chan_freq' 'rpt_chan_chan' 'rpt_chan_freq_time' 'rpttap_chan_freq' 'rpttap_chan_freq_time' 'rpt_other' 'subj_chan_freq_time' 'subj_chan_time'}
          dat = cell(size(varargin));
          for j=1:numel(varargin)
